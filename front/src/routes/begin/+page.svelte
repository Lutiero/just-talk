...
<div class="begin">
  <h1>Just Talk</h1>
  <p>Não desafie seus problemas sozinho(a), converse com pessoas ou profissionais que já passaram por algo parecido.</p>
</div>
<div class="register">
  <span>Entrar ou criar conta</span>
  <a href="http://127.0.0.1:5173/signup">  <button class="buttoncreate">Vamos começar?</button>
  </a>
  <div class="otherwise">
    <div class="google">
      <img src="images/ic_google.png" alt="" class="google-img" />
      <p class="google-txt">Google</p>
    </div>
    <div class="facebook">
      <img src="images/ic_facebook.png" alt="" class="facebook-img" />
...
<style>
  ...
  .begin{
    ...
    height: 500px;
    background: transparent url('icons/begin.svg') 0% 0% no-repeat padding-box;
  }

  .begin h1{
    padding-top: 50px;
    font: normal normal 800 57px/82px Gilroy;
